...
function DetailTabResult({ vinId, model, pre, ubi, fila }: props) {
    return (
        <div className="row mt-3">
            <div className="col-9 ms-1 border border-2 p-1 m-0">
                <p className="p-0 m-0 text-center">{vinId}</p>
            </div>
            <div className="col-9 ms-1 border border-top-0 border-2 p-1 m-0">
                <small className="col p-0 m-0 d-flex justify-content-center">
                    {model}</small>
            </div>
            <div className="col-9 ms-1 d-flex justify-content-around p-0 border-start-1 border-end-1 border border-top-0 border-bottom-0">
